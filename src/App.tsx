...
export default function App() {
  ...
  const handleAutoGenerateForSection = (sectionId: string) => {
    const structuresMap = gradeStructures.reduce((acc, curr) => ({ ...acc, [curr.id]: curr }), {});
    const newEntries = autoGenerateTimetable(subjects, teachers, sections, structuresMap, syncConstraints, simultaneousConstraints, electiveGroups, entries, sectionId);
    setEntries(newEntries);
  };
